...
<div class="main-card mb-3 card">
  <div class="card-body">
      ...
      {!! Form::open(['route' => 'jenis.store','enctype' => 'multipart/form-data']) !!}
          ...
          <div class="position-relative row form-check">
              <div class="col-sm-10 offset-sm-2">
                  {!! Form::button('Simpan', ['class' => 'btn btn-secondary simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Jenis Dokumen']) !!}
              </div>
          </div>
      {!! Form::close() !!}
  </div>
