...
<div class="app-page-title">
    <div class="page-title-wrapper">
      <div class="page-title-heading">
          ...
          <div>Ubah Jenis Dokumen
            <div class="page-title-subheading">Jenis Dokumen untuk dokumen Aplikasi</div>
          </div>
      </div>
    </div>
</div>
<div class="main-card mb-3 card">
  <div class="card-body">
      ...
      {!! Form::model($data_edit, [
          'method' => 'PATCH',
          'url' => ['master/jenis', $data_edit->id],
          'enctype' => 'multipart/form-data'
      ]) !!}

          <div class="position-relative row form-group">
            <label for="exampleEmail" class="col-sm-3 col-form-label">Nama Jenis Dokumen</label>
              <div class="col-sm-8">
          ...
          <div class="position-relative row form-check">
              <div class="col-sm-10 offset-sm-2">
                  {!! Form::button('Simpan', ['class' => 'btn btn-secondary simpan', 'type' => 'submit', 'data-swa-text' => 'Merubah Jenis Dokumen']) !!}
              </div>
          </div>
      {!! Form::close() !!}
  </div>
