...
<div class="app-page-title">
    <div class="page-title-wrapper">
      <div class="page-title-heading">
          ...
          <div>Master Jenis Dokumen
            <div class="page-title-subheading">Jenis Dokumen untuk dokumen Aplikasi</div>
          </div>
      </div>
      <div class="page-title-actions">
        <a href="{{ url('master/jenis/create') }}" class="btn-shadow d-inline-flex align-items-center btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
      </div>
    </div>
</div>
